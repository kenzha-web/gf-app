...
var UploadController = function () {
    ...
    var UploadController = _classThis = /** @class */ (function () {
        function UploadController_1(uploadToAwsProvider) {
            this.uploadToAwsProvider = (__runInitializers(this, _instanceExtraInitializers), uploadToAwsProvider);
        }
        UploadController_1.prototype.uploadFile = function (file) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.uploadToAwsProvider.fileUpload(file)];
                        case 1:
                            uploadedFileKey = _a.sent();
                            return [2 /*return*/, { message: 'File uploaded successfully', fileKey: uploadedFileKey }];
                    }
                });
            });
        };
    ...
    (function () {
        ...
        _uploadFile_decorators = [(0, common_1.Post)('file'), (0, swagger_1.ApiOperation)({ summary: 'Upload a file to AWS S3' }), (0, swagger_1.ApiResponse)({
                status: 201,
            ...
            }), (0, swagger_1.ApiResponse)({ status: 400, description: 'Invalid file upload request' }), (0, swagger_1.ApiConsumes)('multipart/form-data'), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file'))];
