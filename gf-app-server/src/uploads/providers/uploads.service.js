...
var UploadsService = function () {
    ...
    var UploadsService = _classThis = /** @class */ (function () {
         ...
         */
        configService, uploadsRepository) {
            this.uploadToAwsProvider = uploadToAwsProvider;
            this.configService = configService;
            this.uploadsRepository = uploadsRepository;
        }
        UploadsService_1.prototype.uploadFile = function (file) {
            return __awaiter(this, void 0, void 0, function () {
                var path, uploadFile, upload, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 4, , 5]);
                            return [4 /*yield*/, this.uploadToAwsProvider.fileUpload(file)];
                        case 2:
                            path = _a.sent();
                            uploadFile = {
                                name: path,
                                path: "https://".concat(this.configService.get('appConfig.awsCloudfrontUrl'), "/").concat(path),
                                type: file_types_enum_1.fileTypes.IMAGE,
                                mime: file.mimetype,
                                size: file.size,
                            };
                            upload = this.uploadsRepository.create(uploadFile);
                            return [4 /*yield*/, this.uploadsRepository.save(upload)];
                        case 3: return [2 /*return*/, _a.sent()];
                        case 4:
                            error_1 = _a.sent();
                            throw new common_1.ConflictException('Failed to upload file', { cause: error_1 });
