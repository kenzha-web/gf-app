...
exports.CreateManyUsersDto = void 0;
var class_validator_1 = require("class-validator");
var swagger_1 = require("@nestjs/swagger");
var create_user_dto_1 = require("./create-user.dto");
var class_transformer_1 = require("class-transformer");
var CreateManyUsersDto = function () {
    var _a;
    var _users_decorators;
    var _users_initializers = [];
    var _users_extraInitializers = [];
    return _a = /** @class */ (function () {
            function CreateManyUsersDto() {
                this.users = __runInitializers(this, _users_initializers, void 0);
                __runInitializers(this, _users_extraInitializers);
            }
            return CreateManyUsersDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _users_decorators = [(0, swagger_1.ApiProperty)({
                    type: 'array',
                    required: true,
                    items: {
                        type: 'User',
                    },
                }), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.IsArray)(), (0, class_validator_1.ValidateNested)({ each: true }), (0, class_transformer_1.Type)(function () { return create_user_dto_1.CreateUserDto; })];
...
exports.CreateManyUsersDto = CreateManyUsersDto;
