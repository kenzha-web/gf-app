...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        function AuthService_1(signInProvider, refreshTokensProvider) {
            this.signInProvider = (__runInitializers(this, _instanceExtraInitializers), signInProvider);
            this.refreshTokensProvider = refreshTokensProvider;
        }
        AuthService_1.prototype.signIn = function (signInDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.signInProvider.signIn(signInDto)];
                });
            });
        };
        AuthService_1.prototype.refreshTokens = function (refreshTokenDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.refreshTokensProvider.refreshTokens(refreshTokenDto)];
                });
            });
        };
        AuthService_1.prototype.logout = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, {
                            message: "\u041F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C \u0441 ID ".concat(user.sub, " \u0443\u0441\u043F\u0435\u0448\u043D\u043E \u0432\u044B\u0448\u0435\u043B \u0438\u0437 \u0441\u0438\u0441\u0442\u0435\u043C\u044B"),
                        }];
                });
            });
        };
    ...
    (function () {
        ...
        _signIn_decorators = [(0, swagger_1.ApiOperation)({ summary: 'Войти в систему' })];
        _refreshTokens_decorators = [(0, swagger_1.ApiOperation)({ summary: 'Обновить токены' })];
        _logout_decorators = [(0, swagger_1.ApiOperation)({ summary: 'Выйти из системы' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Выход успешно выполнен' })];
