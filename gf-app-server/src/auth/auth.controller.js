...
var AuthController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Аутентификация'), (0, common_1.Controller)('auth')];
        ...
        AuthController_1.prototype.signIn = function (signInDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.signIn(signInDto)];
                });
            });
        };
        AuthController_1.prototype.refreshTokens = function (refreshTokensDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.refreshTokens(refreshTokensDto)];
                });
            });
        };
    ...
    (function () {
        ...
        _signIn_decorators = [(0, swagger_1.ApiOperation)({ summary: 'Войти в систему (Sign-In)' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Успешный вход' }), (0, common_1.Post)('sign-in'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        _refreshTokens_decorators = [(0, swagger_1.ApiOperation)({ summary: 'Обновить токен (Refresh Tokens)' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Токены успешно обновлены' }), (0, common_1.Post)('refresh-tokens'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        _logout_decorators = [(0, swagger_1.ApiOperation)({ summary: 'Выйти из системы (Logout)' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Выход успешно выполнен' }), (0, common_1.Post)('logout'), (0, common_1.UseGuards)(access_token_guard_1.AccessTokenGuard), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
